import YoutubeAudioExtractor from "./main";
import YoutubeAudioExtractorContent from "./ToolContent";
import Navbar from "@/components/Navbar";
import Footer from "@/components/Footer";

export default function YoutubeAudioExtractorPage() {
  return (
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center max-w-3xl mx-auto space-y-4">
              ...
              <p className="text-slate-700 md:text-lg max-w-[800px]">
                Extract and download high-quality audio from YouTube videos instantly. 
                Convert to MP3, WAV, or other formats with our browser-based tool.
              </p>
            </div>
          </div>
        </section>
